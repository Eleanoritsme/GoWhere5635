    ...
    <StatusBar barStyle={'dark-content'} />
      ...
      />
        ...
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyText}>You do not have any reviews yet.</Text>
          <Text style={styles.emptyText}>Share your experience for the place!</Text>
          <TouchableOpacity
            onPress={() => navigation.navigate('Activity')}
            style={styles.buttonContainer}
          >
            <Text style={styles.buttonText}>Have a try</Text>
          </TouchableOpacity>
        </View>
      )}
    </View>
